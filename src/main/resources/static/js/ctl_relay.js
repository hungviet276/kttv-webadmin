...
function updateDeviceInfo(siteId, deviceId){
	...
	$.ajax({
		  method: "POST",
		  url: "/api/device/bysiteid/"+siteId,
		})
		 .done(function( msg ) {
...
function controlSelectOption(state){
	console.log("site info: ", $("#inputSiteInfo").val())
        ...
        "dataFilter": function (response) {
            ...
            for (let i = 0; i < responseJson.content.length; i++) {
                dataRes.data.push({
                    ...
                    "siteCode": responseJson.content[i].site_code,
                    "deviceCode": responseJson.content[i].device_code,
                    ...
                    "siteDeviceId": responseJson.content[i].site_device_id,
                    "siteId": responseJson.content[i].site_id,
                    "deviceId": responseJson.content[i].device_id,
...
function fillDataToForm(rowData) {
    if (rowData != null && rowData != undefined && rowData.length > 0) {
        ...
        $('#r0').val(rowData[0].ir0);
        $('#r1').val(rowData[0].ir1);
        $('#r2').val(rowData[0].ir2);
        $('#r3').val(rowData[0].ir3);
        $('#r4').val(rowData[0].ir4);
        $('#r5').val(rowData[0].ir5);
        $('#r6').val(rowData[0].ir6);
        $('#r7').val(rowData[0].ir7);
        $('#r8').val(rowData[0].ir8);
        $('#r9').val(rowData[0].ir9);
        $('#r10').val(rowData[0].ir10);
        $('#r11').val(rowData[0].ir11);
        $('#r12').val(rowData[0].ir12);
        $('#r13').val(rowData[0].ir13);
        $('#r14').val(rowData[0].ir14);
        $('#r15').val(rowData[0].ir15);
        disableRootElement();
    }
}
