            ...
            if(responseJson.content != null) {
	            for (let i = 0; i < responseJson.content.length; i++) {
	                dataRes.data.push({
	                    ...
	                    "deviceType"	: responseJson.content[i].type_name,
...
$('#tableDataView thead tr:eq(1) th').each( function (i) {
    ...
    if (title != '#') {
    	if (i == 1) {
			$(this).html( "<select class='selectpicker form-control' >"+ $('#inputDeviceType').html() + '</select>');
